    ...
    <form action="{{ route('produk.simpan') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="box2">
            ...
            <div class="nameproduk">
                ...
                <div class="inputname">
                    <input type="text" name="nama_produk" placeholder="Masukan Nama Produk" maxlength="180">
                </div>
            </div>
        ...
        <div class="box3">
            ...
            <div class="keteranganproduk">
                ...
                <div class="inputketerangan">
                    <textarea name="kondisi_produk" id="" cols="80" rows="4"></textarea>
        ...
        <div class="box4">
            ...
            <div class="penyediaanproduk">
                ...
                <div id="ifYes" style="display:none">
                    ...
                    <div class="inputjmlh">
                        <input type="number" name="jumlah" placeholder="Masukan Jumlah Produk" min="1">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="box5">
            ...
            <div class="varianproduk">
                ...
                <div class="inputvarian">
                    <input type="text" name="varian" value="" data-role="tagsinput" placeholder="Add Varian" />
                </div>
            </div>
        </div>
        ...
        <div class="box6">
            ...
            <div class="minimumproduk">
                ...
                <div class="minimumvarian">
                    <input type="number" name="minimum" value="" data-role="tagsinput" placeholder="1" min="1" />
                </div>
            </div>
            <div class="minimumproduk">
                <p class="minimumprod">Harga Satuan</p>
                <div class="minimumvarian er">
                    <input type="text" name="harga_satuan" value="" placeholder="Rp 1,000,000.00" />
                </div>
            ...
            <div class="minimumproduk">
                ...
                <div class="minimumvarian ey">
                    <input type="text" name="harga_grosir" value="" data-role="tagsinput" placeholder="Harga Grosir" />
                </div>
        ...
        <div class="box7">
            ...
            <div class="beratproduk">
                ...
                <div class="inputberat">
                    ...
                    <input type="number" name="jumlah_barat" placeholder="Masukan Total Berat" min="1">
        ...
        <!-- Button -->
        <div class="bttn">
            <a href="produk-pedagang">

                <button class="btn1">
                    Batal
                </button>
            </a>
            <button class="btn2" type="submit" value="simpan">
                Simpan
            </button>
        </div>
    </form>
