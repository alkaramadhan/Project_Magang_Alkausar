    ...
    @csrf
        ...
        <div class="setting1">
            ...
            <div class="formupktpdll">
                ...
                <div class="previmgktp">
                    ...
                    <div class="tulisanupktp">
                        ...
                        <input id="file-upload" name="gambar_ktp" onchange="imgupktp(this);" type="file" />
                    </div>
                </div>
            </div>
            ...
            <div class="prevfile">
                ...
                <div class="input-file-container">
                    <input class="input-file" name="file_siup" id="my-file" type="file"
            ...
            <div class="mnc">
                ...
                <div class="upimg">
                    ...
                    <div class="tulisanimage">
                        ...
                        <input type='file' name="gambar_toko" onchange="img1(this);" />
                    </div>
                </div>
            </div>
            <div class="man">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="dropzone-wrapper">
                                    ...
                                    <input type="file" name="sampul_toko" class="dropzone">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="setting2">
            ...
            <div>
                ...
                <textarea name="catatan_toko" id="" cols="30" rows="10"></textarea>
            </div>
            <button>Save</button>
        ...
        <div class="setting3">
            ...
            <div class="inputt1">
                <p>Alamat Toko</p>
                <input type="text" name="alamat_toko" placeholder="Masukan Alamat">
            </div>
            <div class="inputt2">
