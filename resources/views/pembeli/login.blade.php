...
<head>
    ...
    <link rel="stylesheet" href="css/loginregisterpembeli/login.css">
    ...
    <div class="container">
        <div class="row  justify-content-center">
            <div class="gambar item">
                <img src="image/loginregisterpdgn/beli.svg" width="100%">
                <h1 class="masuk">Masuk</h1>
                <div class="garis1"></div>
                <p class="sebagai">sebagai</p>
                <div class="garis2"></div>
                <p class="pedagang">pembeli</p>
                <p class="atau">atau</p>
                <p class="pembeli">sebagai <a href="{{url('login-pedagang')}}">{{ __('Pedagang') }}</a></p>
            </div>
            <div class="bg">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="emailf">
                        ...
                        <input id="email" type="email" placeholder="Your Email" class="o"
                    ...
                    <div class="passwordf">
                        ...
                        <input id="password" type="password" placeholder="Input Password" class="ippw"
                    ...
                    <div class="regis">
                        Tidak Mempunyai Akun ? <a href="{{url('register-pembeli')}}">Daftar Sekarang</a> <br>
